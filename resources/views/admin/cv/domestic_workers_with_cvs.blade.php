                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            @foreach($get_domestic_workers_with_cv as $i=>$cv)
                                            <tr>
                                                 @php
                                                    if( $get_domestic_workers_with_cv->currentPage() == 1){
                                                        $i = $i+1;
                                                    }else{
                                                        $i = ($i+1) + 10*($get_domestic_workers_with_cv->currentPage()-1);
                                                    }
                                                @endphp
                                                <td>{{$i}}</td>
                                ...
                                <div class="row">
                                   <div class="text-end ml-2">
                                     {{$get_domestic_workers_with_cv->links()}}
                                   </div>
                                </div>
                            </div>
                        </div>
