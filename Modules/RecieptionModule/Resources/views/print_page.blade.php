                    ...
                    <div class="card">
                            <div class="card-body printableArea">
                                ...
                                <div class="col-lg-12 text-center">
                                   ...
                                   <strong> Workers Registered at Reception</strong>
                                </div>
                                </div>
                                </div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $registered_dw->last_name}} {{ $registered_dw->first_name}} {{ $registered_dw->other_names}}</td>
                                                <td>{{$registered_dw->phone_number}}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
