                    ...
                    <div class="card">
                            <div class="card-body printableArea">
                                ...
                                <div class="col-lg-12 text-center">
                                  ...
                                  <strong>Workers Who Renewed Contract</strong>
                                </div>
                                </div>
                              </div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            @endphp
                                                ...
                                                <td><a style="width:50px; height:50px; color:blue;" href="{{asset('dw_employer_visa/'.$dw->visa)}}">View Visa</td>
                                                <td>{{$dw->dw_contact}}</td>
                                                ...
                                                <td>{{$dw->created_at}}</td>
                                                <td><a href="/domesticworkeroverallstatus/edit-dw-info/{{$dw->domestic_worker_id}}" class="btn btn-success btn-sm">Edit</a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
