                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-lg-8">
                                    <form class="mt-4" action="/domesticworkeroverallstatus/save-dw-employer-info/{{request()->route()->dw_id}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                            <label for="visa">Attach Visa</label>
                                                <div class="form-group mb-3">
                                                    <input type="file" class="form-control dropify"  data-max-file-size="4M" name="visa"
                                                        placeholder="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="col-12">
                                                <div class="d-md-fle align-items-center mt-3">
                                                    <div class="ms-aut mt-3 mt-md-0">
                                                        <a href="/domesticworkeroverallstatus/get-dw-employer"  class="btn btn-primary text-white">Back</a>
