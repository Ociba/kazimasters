                ...
                <div class="row">
                    ...
                    <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-lg-8">
                                <form class="mt-4" action="/trainingmodule/save-training-school-info/{{request()->route()->dw_id}}" method="get">
                                @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="d-md-fle align-items-center mt-3">
                                                ...
                                                <a href="/trainingmodule/training-schools" type="button" class="btn btn-primary text-white">Back</a>
