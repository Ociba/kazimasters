                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            @foreach($get_all_training_school_workers as $i=>$school)
                                            <tr>
                                            @php
                                                if( $get_all_training_school_workers->currentPage() == 1){
                                                    $i = $i+1;
                                                }else{
                                                    $i = ($i+1) + 10*($get_all_training_school_workers->currentPage()-1);
                                                }
                                            @endphp
                                                <td>{{$i}}</td>
                                                ...
                                                <td><a href="/trainingmodule/mark-as-sent/{{$school->domestic_worker_id}}"  class="btn btn-danger add-new text-end"><i class="fa fa-plus"></i> Mark as Sent</a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                ...
                                <div class="text-end ml-2">
                                    {{$get_all_training_school_workers->links()}}
                                </div>
                                </div>
                            </div>
                        </div>
