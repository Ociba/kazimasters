                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            @foreach($dw_passports_not_recieved as $i=>$passport)
                                            <tr>
                                                @php
                                                    if( $dw_passports_not_recieved->currentPage() == 1){
                                                        $i = $i+1;
                                                    }else{
                                                        $i = ($i+1) + 10*($dw_passports_not_recieved->currentPage()-1);
                                                    }
                                                @endphp
                                                <td>{{$i}}</td>
                                ...
                                <div class="row">
                                    <div class="text-end ml-2">
                                        {{$dw_passports_not_recieved->links()}}
                                    </div>
                                </div>
                            </div>
                        </div>
