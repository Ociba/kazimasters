                ...
                <div class="row">
                    ...
                    <div class="card">
                            <div class="card-body">
                                ...
                                <div class=" col-lg-4">
                                <form action="/passportmodule/search-dw" method="get">
                                     @csrf
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            @foreach($get_dw_passport_info as $i=>$passport)
                                            <tr>
                                                @php
                                                    if( $get_dw_passport_info->currentPage() == 1){
                                                        $i = $i+1;
                                                    }else{
                                                        $i = ($i+1) + 10*($get_dw_passport_info->currentPage()-1);
                                                    }
                                                @endphp
                                                <td>{{$i}}</td>
