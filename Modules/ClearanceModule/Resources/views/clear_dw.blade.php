                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title">
                                    <form class="mt-4" action="/clearancemodule/clear-dw/{{request()->route()->dw_id}}" method="get">
                                     @csrf
                                    <div class="row text-center">
                                            <div class="col-md-6">
                                                <input type="hidden" name="domestic_worker_id" id="" value="{{request()->route()->dw_id}}">
                                                <input type="hidden" name="created_by" id="" value="{{auth()->user()->id}}">
                                            ...
                                            <div class="col-12">
                                                <div class="d-md-fle align-items-center mt-3">
                                                    <div class="ms-aut mt-3 mt-md-0">
                                                        <a href="/clearancemodule/domestic-workers-with-pending-clearance" button type="button" class="btn btn-primary text-white">Back</button></a>
